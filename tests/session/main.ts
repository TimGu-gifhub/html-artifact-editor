...
async function run(): Promise<void> {
  ...
  try {
    ...
    assert.deepEqual(await ui.webContents.executeJavaScript('Object.keys(haeWorkspace).sort()'), ['edit', 'listRecovery', 'onState', 'open', 'openDirectory', 'read', 'readDiff', 'restore', 'retryPersistence', 'save', 'switchEntry']);
