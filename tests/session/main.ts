...
async function run(): Promise<void> {
  ...
  try {
    ...
    assert.deepEqual(await ui.webContents.executeJavaScript('Object.keys(haeWorkspace).sort()'), ['edit', 'onState', 'open', 'openDirectory', 'read', 'retryPersistence', 'save', 'switchEntry']);
