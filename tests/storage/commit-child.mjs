...
const [privateRoot, entry, candidatePath, stage] = process.argv.slice(2);
...
const value = await store.prepare(source, { bytes, baseHash: source.baseHash, resultHash: digest(bytes) });
