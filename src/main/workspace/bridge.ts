...
const publicErrors = new Set(['WORKSPACE_BUSY', 'STALE_WORKSPACE', 'DOCUMENT_BUSY', 'INPUT_COMPOSING',
  ...
  'HIDDEN_CONTENT_BUSY', 'HIDDEN_CONTENT_UNAVAILABLE', 'HIDDEN_CONTENT_FAILED',
  'DESKTOP_UNAVAILABLE', 'EDITOR_NOT_OWNER', 'INPUT_FLUSH_REQUIRED', 'REVIEW_REQUIRED', 'PDF_BUSY',
  'INTERRUPTION_BUSY', 'INTERRUPTION_REVIEW_REQUIRED', 'INTERRUPTION_RESTART_REQUIRED', 'INTERRUPTION_UNAVAILABLE',
  'RECORD_CLEANUP_BUSY', 'RECORD_CLEANUP_REVIEW_REQUIRED', 'RECORD_CLEANUP_RESTART_REQUIRED', 'RECORD_CLEANUP_UNAVAILABLE',
