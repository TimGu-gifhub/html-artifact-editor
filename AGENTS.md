...
Use the Node/npm versions in docs/DEVELOPMENT.md and Python 3.10+ for documentation checks. Electron test:smoke/security/mapping/patch/draft/editor/workspace/session/project/storage/save-session/recovery/source-diff cover the experiments recorded under docs/implementation/. Windows save tests do not substitute for native-dialog, recovery UI, unavailable-platform or product acceptance. Avoid adding tests that merely mirror low-impact documentation edits.
