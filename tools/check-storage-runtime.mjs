...
try {
  ...
  const files = ['tests/unit/save-preparation.test.mjs', 'tests/unit/backup-review.test.mjs', 'tests/unit/draft-checkpoint-store.test.mjs', 'tests/unit/draft-lifecycle.test.mjs',
    'tests/unit/history-persistence.test.mjs', 'tests/unit/checkpoint-compaction.test.mjs', 'tests/unit/compaction-resolution.test.mjs', 'tests/unit/record-cleanup.test.mjs'];
