...
const entries = {
  ...
  'product-hidden': ['tests/product/hidden-content.ts', 'out/product-hidden'],
  'product-inline': ['tests/product/inline.ts', 'out/product-inline'],
  'product-view': ['tests/product/view-state.ts', 'out/product-view'],
  'product-contextual': ['tests/product/contextual.ts', 'out/product-contextual'],
