...
HAE-010 已新增 [保存事务实验](docs/implementation/HAE-010.md)：私有备份/候选、合作实例锁、Windows 原生替换、结果回读与提交记录，以及重启只读检查。明确调用 Main 的 commit 才替换 HTML；尚未接入正常应用，恢复向导、保存后基线更新和产品验收仍待完成。
